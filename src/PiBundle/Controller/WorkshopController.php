...
class WorkshopController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $workshops = $em->getRepository('PiBundle:Workshop')->findAll();
        $user = $this->getUser();
        ...
        {
            return $this->render('workshop/indexUsers.html.twig', array(
                'workshops' => $workshops,
            ));
        }
    }
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PiBundle\Form\WorkshopType', $workshop);
    ...
    {
        $deleteForm = $this->createDeleteForm($workshop);
        $editForm = $this->createForm('PiBundle\Form\WorkshopType', $workshop);
